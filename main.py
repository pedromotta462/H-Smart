...
class HomePage(MDScreen):
    def on_pre_enter(self, *args):
        self.ids.bemvindo.text = "Bem vindo, Fulano!"
    def callback(self):
        MDApp.get_running_app().root.current = "login"
    def callback_2(self, *args):
        MDApp.get_running_app().root.current = "exercise"
...
class Register(MDScreen):
    def on_pre_enter(self, *args):
        ...
        self.ids.label_register.text = "Preencha com seus dados"
